...
<footer id="footer" class="bg-black">
          ...
          <div class="footer-menu">
            ...
            <div class="social-links mt-4">
              <ul class="d-flex list-unstyled gap-3">
                <li class="social">
                  <a href="https://www.facebook.com/profile.php?id=100088056825172" target="_blank">
                    <iconify-icon class="social-icon fs-5 text-white me-4" icon="ri:facebook-fill"></iconify-icon>
                  </a>
                </li>
                <li class="social">
                  <a href="https://www.tiktok.com/@markiapparelclothes?_t=8oo98PSsSsJ&_r=1" target="_blank">
                    <iconify-icon class="social-icon fs-5 text-white me-4" icon="ri:tiktok-fill"></iconify-icon>
                  </a>
                </li>
                <li class="social">
                  <a href="#">
    ...
    <div class="container padding-medium pt-3">
      <div class="row mt-3">
        <div class="col-md-6 copyright">
          <p class="secondary-font">© 2024 MARKI APPAREL. All rights reserved.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="{{asset('mainpage/js/jquery-1.11.0.min.js')}}"></script>
