                  ...
                  <div class="cart-info d-flex flex-wrap align-items-center ">
                    <div class="col-lg-3">
                      <div class="card-image">
                        <img src="mainpage/images/item1.jpg" alt="cloth" class="img-fluid">
                      </div>
                    </div>
                    <div class="col-lg-9">
                      <div class="card-detail ps-3">
                        <h5 class="card-title">
                          <a href="#" class="text-decoration-none">Printed T-shirt</a>
                        </h5>
                      </div>
                    </div>
                  </div>
              ...
              <tr>
                <td scope="row" class="py-4">
                  <div class="cart-info d-flex flex-wrap align-items-center ">
                    <div class="col-lg-3">
                      <div class="card-image">
                        <img src="mainpage/images/item2.jpg" alt="cloth" class="img-fluid">
                      </div>
                    </div>
                    <div class="col-lg-9">
                      <div class="card-detail ps-3">
                        <h5 class="card-title">
                          <a href="#" class="text-decoration-none">Black T-shirt</a>
                        </h5>
                      </div>
                    </div>
                  </div>
                ...
                <td class="py-4 align-middle">
                  <div class="total-price">
                    <span class="secondary-font fw-medium">$190.00</span>
                  </div>
                </td>
                <td class="py-4 align-middle">
                  <div class="cart-remove">
              ...
              <tr>
                <td scope="row" class="py-4">
                  <div class="cart-info d-flex flex-wrap align-items-center ">
                    <div class="col-lg-3">
                      <div class="card-image">
                        <img src="mainpage/images/item3.jpg" alt="cloth" class="img-fluid">
                      </div>
                    </div>
                    <div class="col-lg-9">
                      <div class="card-detail ps-3">
                        <h5 class="card-title">
                          <a href="#" class="text-decoration-none">Sweat Shirt</a>
                        </h5>
                      </div>
                    </div>
                  </div>
        ...
        <div class="col-md-4">
          <div class="cart-totals">
            ...
            <div class="button-wrap row g-2">
              <div class="col-md-6"><button class="btn btn-outline-dark p-3 w-100">Update Cart</button>
              </div>
              <div class="col-md-6"><button class="btn btn-outline-dark p-3 w-100">Continue Shop</button></div>
